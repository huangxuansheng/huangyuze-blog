import{_ as i,r as c,o as l,c as o,d as n,e as s,f as e,b as t}from"./app-bTNKyK6n.js";const p={},u=t(`<h1 id="前端如何实现即时通讯" tabindex="-1"><a class="header-anchor" href="#前端如何实现即时通讯" aria-hidden="true">#</a> 前端如何实现即时通讯？</h1><h3 id="短轮询" tabindex="-1"><a class="header-anchor" href="#短轮询" aria-hidden="true">#</a> 短轮询</h3><p>短轮询的原理很简单，每隔一段时间客户端就发出一个请求，去获取服务器最新的数据，一定程度上模拟实现了即时通讯。</p><ul><li>优点：兼容性强，实现非常简单</li><li>缺点：延迟性高，非常消耗请求资源，影响性能</li></ul><p>eg：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>function poll() {
  setInterval(() =&gt; {
    fetch(&#39;/api/messages&#39;)
